...
static const uint8_t button_note[N_COLS][N_ROWS] = {
    {0x00, 0x01, 0x02, 0x03, 0x04, 0x05, 0x06, 0x07}, /* col 0 */
    {0x10, 0x11, 0x12, 0x13, 0x14, 0x15, 0x16, 0x17}, /* col 1 */
    {0x20, 0x21, 0x22, 0x23, 0x24, 0x25, 0x26, 0x27}, /* col 2 */
    {0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37}, /* col 3 */
    {0x40, 0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47}, /* col 4 */
    {0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57}, /* col 5 */
    {0x60, 0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67}, /* col 6 */
    {0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77}, /* col 7 */
};
        ...
        if (memcmp(previous_kb_result, current_kb_result, N_COLS) != 0)
        {
            for (int c = 0; c < N_COLS; c++)
            {
                for (int r = 0; r < N_ROWS; r++)
                {
                    ...
                    {
                        USBSendControlChange(MIDI_CHANNEL, button_note[c][r], current_button_state ? MIDI_MAX : 0);
                    }
                }
            }
